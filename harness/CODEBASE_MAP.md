...
study doctrine, machine-readable packs, reference practice code, validators, and media bundle
tooling exist before the full browser application shell is scaffolded.
...
| `tests/` | Executable practice tests. |
| `scripts/` | Validators, media bundle tooling, and harness CLI. |
